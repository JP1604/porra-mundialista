        ...
        <Popover open={comboOpen} onOpenChange={setComboOpen}>
          <PopoverTrigger asChild>
            <Button
              ...
              className={cn(
                'w-full justify-between bg-slate-100 dark:bg-[#1E293B] border-slate-200 dark:border-white/[0.08] text-left font-normal hover:bg-slate-200 dark:hover:bg-[#253548]',
                !selectedPlayer && 'text-slate-400 dark:text-slate-600',
                selectedPlayer && 'text-slate-900 dark:text-white',
                isSelectedBlocked && 'border-red-300 dark:border-red-700/50 text-red-500 dark:text-red-400'
              )}
            >
              {selectedPlayer
          ...
          <PopoverContent className="w-full p-0 bg-white dark:bg-[#0F172A] border-slate-200 dark:border-white/[0.09]" align="start">
            <Command className="bg-transparent">
              <CommandInput
                placeholder="Buscar jugador…"
                className="bg-transparent text-slate-900 dark:text-white border-b border-slate-200 dark:border-white/[0.08] placeholder:text-slate-400 dark:placeholder:text-slate-600"
              />
                  ...
                  >
                    {group.players.map(player => (
                      <CommandItem
                        ...
                        className="flex items-center justify-between cursor-pointer text-slate-600 dark:text-slate-300 hover:text-slate-900 dark:hover:text-white aria-selected:bg-slate-100 dark:aria-selected:bg-white/[0.06] aria-selected:text-slate-900 dark:aria-selected:text-white"
                      >
                        <div>
